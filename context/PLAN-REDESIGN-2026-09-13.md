...
| B7 хвост | сделан 2026-09-18, коммиты `92f74d6`, `5ca3c73`, `0ec076e`; опубликован в `preview` (`dd4c09c4…`). `Bobo.tsx`, `missed`, `language`, `parent-add-child`, `setup/pet`, `setup/notify` удалены; «Сохранить» в расписании и целях пишет на сервер; `story`, `songs`, `photo-learn`, `topics` и часть `setup/*` недостижимы — не переделывались, ждут решения владельца | `SESSION-2026-09-15-handoff.md` |
...
выше). Осталось решение владельца по недостижимым экранам. Точка входа для новой сессии —
