...
|---|---|---|
| B0 | сделан 2026-09-14, коммит `762465c`; **через EAS Update не опубликован**, на устройстве не проверен | `SESSION-2026-09-14-handoff.md` |
| B2 + имя Bobo + сервер | сделано 2026-09-14, **не закоммичено**; API **выложен** на Fly (версия 3) из рабочей копии | `SESSION-2026-09-14-handoff.md` |
| B3 главный (по пункту 12) | сделано 2026-09-14, **не закоммичено**, в веб-превью проверено | `SESSION-2026-09-14-handoff.md` |
| B1, B4–B7 | не начаты | |
