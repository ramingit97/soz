...
- **[SESSION-2026-09-20-handoff.md](./SESSION-2026-09-20-handoff.md)** — две копии
  репозитория на компьютере (`~/Desktop/langapp` актуальная, `~/soz` отстаёт),
  где лежат сессии Claude Code и как продолжать в Desktop / Remote Control.
  Кода не менялось.
- **[PLAN-REDESIGN-2026-09-13.md](./PLAN-REDESIGN-2026-09-13.md)** — одобренный план
  ...
  эмодзи, батчи B0–B7 через EAS Update. В начале — уточнения владельца от 2026-09-14
  (они главнее текста плана), в разделе F — прогресс по батчам. Бриф дизайнеру
  `DESIGN-BRIEF-2026-09-13.md` решено не отправлять.
- **[SESSION-2026-09-15-handoff.md](./SESSION-2026-09-15-handoff.md)** — B1 (маскот:
  медвежонок и робот, экран проверки `dev/mascot`), B4 (разговор, темы, память,
  история), B5 (экраны уроков: общая шапка, язык интерфейса, медвежонок вместо
  робота во встроенных уроках), B6 (родительский раздел, пейволл, согласие) и B7
  (хвост, недостижимые экраны, исправление API), публикации `26cf1396`,
  `70435a03`, `6686893e`, `dd4c09c4`, открытые вопросы владельцу, ловушки 16–24
  (память машины и перезапуски сессии).
- **[SESSION-2026-09-14-handoff.md](./SESSION-2026-09-14-handoff.md)** — проверка плана
  редизайна по коду, решения владельца (согласие, цвет Хани, шрифты), батч B0
  (коммит `762465c`, не опубликован), проверки, девять ловушек, способ снимать
...
- `PLAN-REDESIGN-CD-2026-09-20.md` — план нового редизайна по макетам C и D (этапы 0–10).
- `SESSION-2026-09-20-redesign-CD.md` — что сделано в этапах 0–6a, ловушки, что осталось.
- `mockups/` — четыре HTML-макета (A, B, C, D) и оглавление `index.html`. Выбраны C для детей и D для взрослых.
