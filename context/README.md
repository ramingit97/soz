...
- **[SESSION-2026-09-15-handoff.md](./SESSION-2026-09-15-handoff.md)** — B1 (маскот:
  ...
  история) и B5 (экраны уроков: общая шапка, язык интерфейса, медвежонок вместо
  робота во встроенных уроках), публикации `26cf1396` и `70435a03`, открытые
  вопросы владельцу, ловушки 16–23 (память машины и перезапуски сессии).
