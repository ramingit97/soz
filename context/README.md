...
- **[SESSION-2026-09-15-handoff.md](./SESSION-2026-09-15-handoff.md)** — B1 (маскот:
  медвежонок и робот, экран проверки `dev/mascot`) и B4 (разговор, темы, память,
  история), публикация `26cf1396`, открытые вопросы владельцу, ловушки 16–22 (память
  машины и перезапуски сессии).
