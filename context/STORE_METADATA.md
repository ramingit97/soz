...
> **честный триал без карты**, **AI-друг с памятью**, **безопасность/родительский контур**.
> Замени `Söz` на финальное имя в сторе, если отличается. Скриншоты/иконка — отдельно.
...
повторение — всё вплетено в единый путь.

🔒 **Безопасно и честно.**
- 7 дней бесплатно **без привязки карты** — вы сами решаете, продлевать ли.
- Родительский контур за PIN: настройки, отчёты, прогресс.
...
- **AZ:** dil,uşaq,ingilis,rus,müəllim,AI,danışıq,öyrən,tələffüz,məktəb
- **EN:** language,kids,english,russian,tutor,ai,speak,learn,conversation,pronunciation,child,school

## Категория / возраст
- Категория: Education (втор.: Kids на Play при выполнении требований Families).
- Возрастной рейтинг: 4+ (App Store) / Everyone (Play). Проверь Families Policy на Play.
- **Kids Category (App Store):** решить, подавать ли — тогда обязательна строгая приватность
  (без сторонней аналитики/рекламы, родительский гейт). См. COPPA-LEGAL-CHECKLIST.md.

## Обязательные ссылки
- Privacy Policy URL: экран в приложении (`legal/privacy`) → нужен ПУБЛИЧНЫЙ URL (хостинг).
- Support URL / email: ramin.web.97@gmail.com.
- Terms URL: подготовить.
...
- [ ] Проверить, что имя `Söz` свободно/зарегистрировано в обоих сторах.
