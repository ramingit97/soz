        ...
        <Animated.View entering={FadeInDown.duration(500)}>
          ...
          <Section title={isAz ? '2. Səs yazıları' : '2. Аудиозаписи'}>
            {isAz
              ...
              : 'Во время разговора с Bobo аудио передаётся партнёрам Deepgram (распознавание) и OpenAI (генерация ответа). Сами аудиофайлы НЕ сохраняются — только текстовая расшифровка привязывается к профилю. Расшифровки автоматически удаляются через 90 дней после последнего разговора.'}
          </Section>
