...
const RU: Record<number, LessonData> = {
  1: {
    theme: 'Знакомство с Bobo',
    themeEmoji: '🤖',
    vocabulary: ['привет', 'имя', 'друг', 'дом', 'робот'],
    story: [
      { text: 'Привет! Я Bobo. Я добрый робот.', emoji: '🤖' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: привет, имя, друг, дом, робот. Спроси как зовут, где живёт, есть ли питомец. Поощряй. Не объясняй грамматику — просто беседуй. Предложения 3-7 слов.',
    reward: { stars: 12, message: 'Отлично! Ты познакомился с Bobo и получил лампу для его дома!' },
  },
  ...
  2: {
    ...
    story: [
      { text: 'Bobo любит рисовать! У него много красок.', emoji: '🎨' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: красный, синий, зелёный, жёлтый, белый. Спроси какой любимый цвет. Попроси описать цвета вещей вокруг. Короткие весёлые предложения.',
    reward: { stars: 14, message: 'Замечательно! Ты знаешь все цвета! Bobo нарисовал радугу специально для тебя!' },
  },
  ...
  3: {
    ...
    story: [
      { text: 'У Bobo большая семья роботов!', emoji: '👨‍👩‍👧' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: мама, папа, сестра, брат, семья. Спроси о семье ребёнка. Тепло и просто. Только короткие предложения.',
    reward: { stars: 14, message: 'Отлично! Теперь Bobo знает твою семью! Он сделал семейное фото для тебя!' },
  },
  ...
  4: {
    ...
    story: [
      { text: 'Bobo готовит завтрак сегодня. Как вкусно!', emoji: '🍳' },
      { text: 'У него яблоко, хлеб и молоко.', emoji: '🍎' },
      { text: 'А потом Bobo съел большой вкусный торт! Ммм!', emoji: '🎂' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: яблоко, хлеб, молоко, торт, есть. Спроси что ел на завтрак. Какая любимая еда? Короткие весёлые предложения.',
    reward: { stars: 14, message: 'Супер! Ты знаешь вкусные слова! Bobo испёк торт специально для тебя!' },
  },
  ...
  5: {
    ...
    story: [
      { text: 'Bobo идёт в зоомагазин сегодня!', emoji: '🐾' },
      { text: 'Там весёлая собака и спящая кошка.', emoji: '🐶' },
      { text: 'Bobo купил маленькую рыбку. Его новый питомец!', emoji: '🐠' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: собака, кошка, птица, рыба, кролик. Спроси есть ли питомец. Каких животных любит? Весело и коротко.',
    reward: { stars: 16, message: 'Замечательно! Ты знаешь всех животных! Bobo завёл рыбку для своего дома!' },
  },
  ...
  6: {
    ...
    story: [
      { text: 'Bobo проверяет все детали своего тела.', emoji: '🔧' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: рука, глаз, нос, рот, ухо. Поиграй с ребёнком — говори «потрогай нос!» и жди ответа. Весело и активно!',
    reward: { stars: 16, message: 'Отлично! Bobo хлопает своими роботскими руками за тебя!' },
  },
  ...
  7: {
    ...
    story: [
      { text: 'Bobo любит считать свои лампочки!', emoji: '🔢' },
      { text: 'У него четыре лампочки и пять друзей-роботов!', emoji: '🏮' },
      { text: 'Считай с Bobo! Один! Два! Три!', emoji: '🎉' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: один, два, три, четыре, пять. Считай предметы вместе с ребёнком. Как в игровом шоу — весело!',
    reward: { stars: 18, message: 'Ура! Ты умеешь считать до пяти! Bobo даёт тебе 5 золотых звёзд!' },
  },
  ...
  8: {
    ...
    story: [
      { text: 'Bobo идёт в школу роботов сегодня!', emoji: '🏫' },
      { text: 'Учитель даёт ему большую книгу.', emoji: '📚' },
      { text: 'Bobo пишет ручкой. Он любит учиться!', emoji: '✏️' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: школа, учитель, книга, ручка, учиться. Спроси о школе ребёнка, любимом предмете, лучшем учителе. Короткие предложения.',
    reward: { stars: 16, message: 'Отличник! Bobo получил золотую звезду в школе роботов — как ты!' },
  },
  ...
  9: {
    ...
    story: [
      { text: 'Bobo показывает свой дом изнутри!', emoji: '🏠' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: кухня, спальня, стол, стул, дверь. Спроси про дом ребёнка — что есть на кухне? Где спит? Простые вопросы.',
    reward: { stars: 16, message: 'Отлично! Bobo добавил новую комнату в свой дом!' },
  },
  ...
  10: {
    ...
    story: [
      { text: 'Bobo одевается на важный день!', emoji: '👕' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: рубашка, туфли, шляпа, платье, куртка. Спроси что ребёнок сейчас надет. Какая любимая одежда? Весело и легко!',
    reward: { stars: 16, message: 'Стильно! Bobo надел лучший наряд, чтобы отпраздновать твой успех!' },
  },
  ...
  11: {
    ...
    story: [
      { text: 'Bobo смотрит в окно. Какая погода?', emoji: '🌤️' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: солнце, дождь, снег, ветер, облако. Спроси какая погода сейчас. Снег или солнце — что больше нравится? Что делают в дождливый день?',
  ...
  12: {
    ...
    story: [
      { text: 'Bobo хочет путешествовать по всему миру!', emoji: '🌍' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: машина, автобус, поезд, самолёт, велосипед. Спроси как добирается до школы. Летал ли на самолёте? Любимый транспорт?',
    reward: { stars: 18, message: 'Путешественник! Bobo летит на роботском самолёте в твою честь!' },
  },
  ...
  13: {
    ...
    story: [
      { text: 'У Bobo насыщенный день впереди!', emoji: '⏰' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: утро, день, вечер, ночь, сегодня. Спроси что делает ребёнок утром. Во сколько встаёт? Что делает вечером?',
    reward: { stars: 16, message: 'Молодец! Ты знаешь все части дня. Bobo сделал тебе часы!' },
  },
  ...
  14: {
    ...
    story: [
      { text: 'Bobo идёт на рынок. Столько фруктов!', emoji: '🛒' },
      { text: 'Он берёт жёлтый банан и сладкий виноград.', emoji: '🍇' },
      { text: 'Bobo покупает ещё морковь и красный помидор!', emoji: '🥕' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: апельсин, банан, виноград, морковь, помидор. Спроси какие фрукты нравятся. Едят ли овощи? Самая любимая полезная еда?',
    reward: { stars: 16, message: 'Очень полезно! Bobo ест банан, чтобы отметить твой прогресс!' },
  },
  ...
  15: {
    ...
    story: [
      { text: 'Bobo идёт на прогулку в лес!', emoji: '🌳' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: дерево, цветок, река, лес, небо. Спроси нравится ли природа. Есть ли деревья рядом с домом? Любимое место на свежем воздухе?',
    reward: { stars: 18, message: 'Прекрасно! Bobo посадил дерево в своём саду специально для тебя!' },
  },
  ...
  16: {
    ...
    story: [
      { text: 'Bobo любит спорт! Он бегает каждое утро.', emoji: '🏃' },
      { text: 'Он прыгает высоко и пинает футбольный мяч.', emoji: '⚽' },
      { text: 'В жаркий день Bobo плавает в реке!', emoji: '🏊' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: бегать, прыгать, плавать, пинать, мяч. Спроси какой спорт нравится. Умеет ли плавать? Играет ли в футбол? Будь энергичным!',
    reward: { stars: 18, message: 'Чемпион! Bobo делает круг почёта специально для тебя!' },
  },
  ...
  17: {
    ...
    story: [
      { text: 'Bobo любит искусство — он рисует весь день.', emoji: '🎨' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: петь, танцевать, рисовать, музыка, краски. Спроси нравится ли музыка. Умеет ли петь или танцевать? Рисует ли?',
    reward: { stars: 18, message: 'Творческий гений! Bobo повесил твой портрет в свою галерею!' },
  },
  ...
  18: {
    ...
    story: [
      { text: 'У Bobo много разных чувств каждый день!', emoji: '😊' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: радостный, грустный, злой, испуганный, взволнованный. Спроси как ребёнок себя чувствует. Что делает радостным? Чего боится?',
    reward: { stars: 18, message: 'Bobo очень взволнован за тебя! Ты делаешь всё замечательно!' },
  },
  ...
  19: {
    ...
    story: [
      { text: 'Ой нет! Bobo заболел сегодня.', emoji: '🤒' },
      { text: 'Доктор-робот даёт ему лекарство.', emoji: '💊' },
      { text: 'После сна Bobo чувствует себя намного лучше!', emoji: '😊' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: больной, доктор, лекарство, спать, лучше. Спроси когда последний раз болел. Ходит ли к доктору? Что помогает поправиться?',
    reward: { stars: 18, message: 'Будь здоров! Bobo приготовил тебе роботский суп для сил!' },
  },
  ...
  20: {
    ...
    story: [
      { text: 'Bobo думает: какая профессия будет у него?', emoji: '🤔' },
      { text: 'Может, пилот на самолёте? Или повар?', emoji: '✈️' },
      { text: 'Bobo решает — хочет стать учителем!', emoji: '👨‍🏫' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: учитель, доктор, повар, пилот, художник. Спроси кем хочет стать ребёнок. Кем работают мама или папа? Самая крутая профессия?',
    reward: { stars: 18, message: 'Мечтай по-крупному! Bobo будет твоим самым большим болельщиком!' },
  },
  ...
  21: {
    ...
    story: [
      { text: 'Bobo исследует город сегодня.', emoji: '🏙️' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: парк, магазин, библиотека, кафе, больница. Какие места часто посещает? Любит ли ходить в парк? Бывал ли в библиотеке?',
    reward: { stars: 20, message: 'Исследователь города! Bobo написал твоё имя на карте города!' },
  },
  ...
  22: {
    ...
    story: [
      { text: 'Bobo любит все четыре времени года!', emoji: '🌍' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: весна, лето, осень, зима, сезон. Спроси какое любимое время года и почему. Чем занимаются в разные сезоны?',
    reward: { stars: 20, message: 'Чемпион всех сезонов! Bobo построил тебе четырёхсезонный сад!' },
  },
  ...
  23: {
    ...
    story: [
      { text: 'Друзья Bobo приходят в гости! Шесть, семь, восемь...', emoji: '🤖' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: шесть, семь, восемь, девять, десять. Считайте вещи вместе — сколько комнат в доме? Сколько людей в семье? Считайте до 10!',
  ...
  24: {
    ...
    story: [
      { text: 'Bobo первый раз видит море!', emoji: '🌊' },
      { text: 'Он ходит по тёплому песку и находит ракушку.', emoji: '🐚' },
      { text: 'Большие волны брызгают на него. Bobo смеётся!', emoji: '😄' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: море, пляж, волна, песок, ракушка. Спроси был ли у моря. Что делают на пляже? Любит ли плавать в море?',
    reward: { stars: 20, message: 'Герой пляжа! Bobo нашёл ракушку с твоим именем!' },
  },
  ...
  25: {
    ...
    story: [
      { text: 'Bobo любит технологии — он ведь робот!', emoji: '🤖' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: телефон, компьютер, игра, видео, экран. Спроси в какие игры играет. Есть ли компьютер? Любимое приложение или видео?',
    reward: { stars: 20, message: 'Технический гений! Bobo обновил свой робо-мозг специально для тебя!' },
  },
  ...
  26: {
    ...
    story: [
      { text: 'Чем Bobo занимается в свободное время?', emoji: '🎯' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: читать, готовить, коллекционировать, строить, хобби. Спроси какое хобби у ребёнка. Что-то коллекционирует? Умеет готовить?',
    reward: { stars: 20, message: 'Творческая звезда! Bobo вдохновлён твоими хобби!' },
  },
  ...
  27: {
    ...
    story: [
      { text: 'У Bobo есть план на каждый день недели!', emoji: '📅' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: понедельник, вторник, среда, четверг, пятница. Спроси что делает ребёнок каждый день недели. Любимый день? Что делает в пятницу?',
    reward: { stars: 20, message: 'Мастер недели! Bobo сделал тебе личный роботский календарь!' },
  },
  ...
  28: {
    ...
    story: [
      { text: 'Bobo любит противоположности — это так весело!', emoji: '🔄' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: большой, маленький, быстрый, медленный, новый. Поиграй в противоположности — ты говоришь «большой», ребёнок говорит «маленький»!',
    reward: { stars: 22, message: 'Гений противоположностей! Bobo и большой, и маленький, когда танцует!' },
  },
  ...
  29: {
    ...
    story: [
      { text: 'Bobo считает, что доброта делает мир лучше!', emoji: '💛' },
      { text: 'Он помогает друзьям и делится едой.', emoji: '🤝' },
      { text: 'Вместе они сильнее! Bobo любит тебя!', emoji: '❤️' },
    ],
    wordGame: [
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Слова урока: добрый, помогать, делиться, любовь, вместе. Спроси как ребёнок проявляет доброту. Помогает ли дома? Кого любит? Говори о дружбе и заботе.',
    reward: { stars: 24, message: 'У тебя золотое сердце! Bobo любит тебя и очень тобой гордится!' },
  },
  ...
  30: {
    ...
    story: [
      ...
      { text: 'Bobo говорит: СПАСИБО за каждый урок вместе!', emoji: '🙏' },
    ...
    talkSystemPrompt:
      'Ты — Bobo, дружелюбный робот, общаешься ТОЛЬКО на русском языке. Это финальный урок! Отпразднуй вместе с ребёнком. Спроси какой урок был любимым. Какое новое слово он любит больше всего? Скажи как ты им гордишься!',
    reward: { stars: 30, message: 'ТЫ СДЕЛАЛ ЭТО! 30 дней уроков! Bobo — твой самый большой фанат навсегда!' },
  },
};
